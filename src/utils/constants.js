...
export const BIOMETRIC_FIELDS = [
  ...
  { id: 'muscleMass', label: 'M. Muscolare (kg)', type: 'number', props: 'step="0.1"' },
  { id: 'fatMass', label: 'M. Grassa (kg)', type: 'number', props: 'step="0.1"' },
  ...
  { id: 'basalMetabolism', label: 'Metabolismo B. (kcal)', type: 'number', props: 'step="1" readonly' },
