...
const UI_TEXT_CONFIG = [
  ...
  { id: 'ADD_WORKOUT_BTN', text: 'Aggiungi Allenamento' },
  { id: 'SELECT_WORKOUT_TITLE', text: 'Scegli Allenamento' },
  { id: 'NO_WORKOUTS_AVAILABLE', text: 'Nessun allenamento disponibile.' },
