...
* **US-3 (Pianificazione via Modale):** Come utente, voglio poter cliccare su uno slot vuoto del calendario per aprire un modale e selezionare un pasto da una lista filtrata.
